...
# Abandoned features
- the update class in server_download.py needs refinement (if not an overhaul) 
  - ideally would add something that can update the database every 6 hours whilst the server is running.
